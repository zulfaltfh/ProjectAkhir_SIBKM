...
namespace API.Migrations
{
    ...
    [Migration("20230624145504_AddTablesandCardinality")]
    partial class AddTablesandCardinality
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Models.DetailBarMasuk", b =>
                {
                    ...
                    b.Property<string>("BarangKodeBarang")
                        .HasColumnType("varchar(10)");
            ...
            modelBuilder.Entity("API.Models.DetailBarMasuk", b =>
                {
                    b.HasOne("API.Models.Barang", "Barang")
                        ...
                        .HasForeignKey("BarangKodeBarang");
